...
func (router RouterGroup) SocialRouter() {
	...
	router.GET("social/manage/community", middleware.JwtAdmin(), app.AdminCommunityPostListView)
	...
	router.GET("social/community/meta", app.CommunityMetaView)
	router.GET("social/community/posts", app.CommunityPostListView)
	router.GET("social/community/posts/:id", app.CommunityPostDetailView)
	router.POST("social/community/posts", middleware.JwtAuth(), app.CommunityPostCreateView)
	router.DELETE("social/community/posts/:id", middleware.JwtAuth(), app.CommunityPostRemoveView)
	router.POST("social/community/posts/:id/replies", middleware.JwtAuth(), app.CommunityReplyCreateView)
	router.POST("social/community/posts/:id/accept", middleware.JwtAuth(), app.CommunityBountyAcceptView)
	router.PUT("social/community/posts/:id/status", middleware.JwtAuth(), app.CommunityPostStatusView)
	router.PUT("social/community/posts/:id/pin", middleware.JwtAdmin(), app.CommunityPostPinView)
