...
func InitGorm() *gorm.DB {
	...
	*/
	...
	sqlDB.SetMaxOpenConns(global.Config.Mysql.MaxOpenConns)                          // 最多可容纳
	sqlDB.SetConnMaxLifetime(time.Duration(global.Config.Mysql.Timeout) * time.Hour) // 连接最大复用时间，不能超过mysql的wait_timeout
	return db
}
